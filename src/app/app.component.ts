...
export class AppComponent {
  ...
  masterVideoList: Video[] = [
    new Video("Man arrested in connection to suspicious devices", "https://yt3.ggpht.com/a-/AN66SAz-dUVC7Ze4UxFf8Vzu1Z3tt0HnsyiTOVPdWg=s48-mo-c-c0xffffffff-rj-k-no", this.masterChannelList[6], "Federal authorities arrest a person in Florida in connection to the packages containing suspected explosives, multiple law enforcement sources say.", [this.masterCategoryList[1]], 4 * 60 + 12),
    new Video("Man arrested in connection to suspicious devices", "https://yt3.ggpht.com/a-/AN66SAz-dUVC7Ze4UxFf8Vzu1Z3tt0HnsyiTOVPdWg=s48-mo-c-c0xffffffff-rj-k-no", this.masterChannelList[6], "Federal authorities arrest a person in Florida in connection to the packages containing suspected explosives, multiple law enforcement sources say.", [this.masterCategoryList[1]], 4 * 60 + 12),
    new Video("Man arrested in connection to suspicious devices", "https://yt3.ggpht.com/a-/AN66SAz-dUVC7Ze4UxFf8Vzu1Z3tt0HnsyiTOVPdWg=s48-mo-c-c0xffffffff-rj-k-no", this.masterChannelList[6], "Federal authorities arrest a person in Florida in connection to the packages containing suspected explosives, multiple law enforcement sources say.", [this.masterCategoryList[1]], 4 * 60 + 12),
    new Video("Man arrested in connection to suspicious devices", "https://yt3.ggpht.com/a-/AN66SAz-dUVC7Ze4UxFf8Vzu1Z3tt0HnsyiTOVPdWg=s48-mo-c-c0xffffffff-rj-k-no", this.masterChannelList[6], "Federal authorities arrest a person in Florida in connection to the packages containing suspected explosives, multiple law enforcement sources say.", [this.masterCategoryList[1]], 4 * 60 + 12),
  ];
